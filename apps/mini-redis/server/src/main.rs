...
//! NOTE: NOW we don't support `clap` on ArceOS.
//!
//! Start a server (port 5555) on one terminal:
//! $ ./build.arceos
//!
//! Run mini-redis-cli in another terminal to test:
//! $ cargo run --bin mini-redis-cli -- --port 5555 set hello world
//! $ cargo run --bin mini-redis-cli -- --port 5555 get hello
//! $ cargo run --bin mini-redis-cli -- --port 5555 ping
//! $ cargo run --bin mini-redis-cli -- --port 5555 subscribe topic
//! $ cargo run --bin mini-redis-cli -- --port 5555 publish topic business
//!
